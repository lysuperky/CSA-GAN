    ...
    def __getitem__(self, index):
        ...
        if self.bbox is not None:
            ...
            if self.split_name == 'train':
                data_dir = '/data3/yukai/data/coco/train2014'
            else:
                data_dir = '/data3/yukai/data/coco/val'
        #
        ...
        # wrong idx for datasets 
        wrong_idx = random.randint(0, len(self.filenames))
        wrong_new_sent_idx = wrong_idx * self.embeddings_num  + sent_ix
        wrong_caps, wrong_cap_len = self.get_caption(wrong_new_sent_idx)
